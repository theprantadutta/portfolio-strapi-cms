...
export interface ApiExperienceExperience extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date: Attribute.String & Attribute.Required & Attribute.Unique;
    soryBy: Attribute.Integer & Attribute.Required & Attribute.Unique;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    imageUrls: Attribute.Media<'images' | 'videos', true> & Attribute.Required;
